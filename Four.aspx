<%@ Page Title="" Language="C#" MasterPageFile="~/模板页.Master" AutoEventWireup="true" CodeBehind="Four.aspx.cs" Inherits="GZDXCC.Four" %>
        ...
        <ItemTemplate>
            <tr>
                <td style="font-size: 13px; line-height: 1.5;">
                    <a style="text-decoration: none; color: <%#Eval("TitleColor")%>" href="Four.aspx?id=<%#Eval("ID") %>">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div id="position" style="margin-top: 17px; margin-left: 50px; color: #E2E25E;">
        当前位置:<a href="Four.aspx" style="text-decoration: none; color: #E2E25E;">扶老助残</a></div>
